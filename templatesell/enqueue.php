...
function polite_scripts() {
    ...
    /*body  */
    wp_enqueue_style('polite-body', '//fonts.googleapis.com/css?family=Roboto:400,400i,500,600,700&display=swap', array(), null);
    /*heading  */
    wp_enqueue_style('polite-heading', '//fonts.googleapis.com/css?family=Roboto:500,600,700&display=swap', array(), null);
